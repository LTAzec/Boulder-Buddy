...
een website waar je je kan registreren als user (klimmer) en kunnen daar de volledige boulder zaal bekijken met foto's en videos. 
Een Routesetter is ook een rol op deze website, dit zijn mensen die boulders kunnen toevoegen en verwijderen, maar geen rollen kunnen aanpassen. 
een Admin, dit is meestal het account van de zaak uitbader, deze kan rollen en boulders aanpassen. 
...
url chat:
https://v0.app/chat/bouldering-gym-webapp-i7b6gtRuurb?ref=H4G2H6
